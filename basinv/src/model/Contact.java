...
public class Contact implements Business {
	...
	public String toString() {
		...
		buffer.append("\nContact:\t"+getIdContact()+" for Customer:\t" + getIdCus() + "\n\t" + getConLName()
				+ ", " + getConFName() + ", " + getConPhone() + ", "
				+ getConMobile() + ", " + getConEMail() + ", " + getConLang()
				+ ", " + getConPref() + ", " + getConTitle() + ", " + isActive());
	...
	public boolean equals(Contact contact){
		...
		if(!this.getConLang().equalsIgnoreCase(contact.getConLang())){
			return false;
		}
