...
public class Invoice implements Business {
	...
	public Invoice(String idInvoice, String invCusid, String invAddid, String invDlvAddid,
			Date invCrtDate, String invCrtUserid, Date invUpdDate,
			String invUpdUserid, Date invDate, Date invDueDate,
			String invStatus, String invType, boolean invVat,
