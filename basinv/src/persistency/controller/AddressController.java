...
public class AddressController {
	...
	public static Collection<Business> getAddresses(String[] filter) {
		...
		list = facade.getResult(BusinessTypeEnum.ADDRESS, callableStatement
	 ...
	 * @throws Exception
	 */
	public static void prepareAddress(Address address, Object[] args, int[] argsType, ArgIO[] argsIO,
	...
	public static boolean createAddress(Address address) {		
		...
		for (int i = 0; i < args.length; i++) {
			try {
				AddressController.prepareAddress(address, args, argsType, argsIO, i);
			} catch (Exception e) {
