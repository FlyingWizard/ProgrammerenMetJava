...
public class ContactController {
	 ...
	 * @throws Exception
	 */
	public static void prepareContact(Contact contact, Object[] args, int[] argsType, ArgIO[] argsIO,
	...
	public static boolean createContact(Contact contact) {
		...
		for (int i = 0; i < args.length; i++) {
			try {
				ContactController.prepareContact(contact, args, argsType, argsIO, i);
			} catch (Exception e) {
	...
	public static Collection<Business> getContacts(String[] filter) {
		...
		list = facade.getResult(BusinessTypeEnum.CONTACT, callableStatement
