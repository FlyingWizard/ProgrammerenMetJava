...
public class ProductController {
	 ...
	 * @throws Exception
	 */
	public static void prepareProduct(Product product, Object[] args, int[] argsType, ArgIO[] argsIO,
	...
	public static boolean createProduct(Product product) {
		...
		for (int i = 0; i < args.length; i++) {
			try {
				ProductController.prepareProduct(product, args, argsType, argsIO, i);
			} catch (Exception e) {
