...
public class TestDummyInvoiceDetail extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		invoice = DummyInvoice.createInvoice(customer.getIdCus(), address.getIdAddress());
		...
		detail = DummyInvoiceDetail.createInvoiceDetail(invoice.getIdInvoice(), product.getIdProd());
	}
